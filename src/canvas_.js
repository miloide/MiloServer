...
Canvas.prototype.setCanvas = function(){
    var canvasId = Blockly.JavaScript.variableDB_.getDistinctName(
        'canvasDiv', Blockly.Variables.NAME_TYPE);
    ...
    body.appendChild(this.eraser);
    body.appendChild(this.clear);
    $("#graph_output").show();
}
